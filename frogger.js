...
function checkDeath() {
  ...
  if (frogY > 280 && frogY < 360 && !lilipadsX.some(function (x) {
...
function renderBackground(canvas) {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    ctx.drawImage(imgMiddle, i * 100, 200, 100, 100);
    ctx.drawImage(imgRiver, i * 100, 300, 100, 100);
    ctx.drawImage(imgMiddle, i * 100, 400, 100, 100);
